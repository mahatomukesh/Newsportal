      ...
      <footer className="bg-gray-900 text-white py-12 mt-12">
        <div className="container mx-auto px-4 max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold mb-4">RamBlog</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-400 hover:text-white transition cursor-default">
                ...
                <span className="text-sm">123 Media Plaza, News City, NY 10001</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400 hover:text-white transition">
                <svg className="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contact@ramblog.com" className="text-sm">contact@ramblog.com</a>
              </div>
              <div className="flex items-center gap-3 text-gray-400 hover:text-white transition">
                <svg className="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+15550001234" className="text-sm">+1 (555) 000-1234</a>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center border-t border-gray-800 pt-6">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} RamBlog. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
